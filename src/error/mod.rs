...
impl IntoResponse for AppError {
    fn into_response(self) -> Response {
        let (status, code) = match &self {
            ...
            AppError::InvalidAccentColor(_) => {
                (StatusCode::UNPROCESSABLE_ENTITY, "invalid_accent_color")
            }
            ...
            AppError::BotRateLimitExceeded(_) => {
            ...
            AppError::LoginRateLimitExceeded(_) => {
                (StatusCode::TOO_MANY_REQUESTS, "LOGIN_RATE_LIMIT_EXCEEDED")
            }
            ...
            AppError::CannotTerminateCurrent => {
                (StatusCode::BAD_REQUEST, "CANNOT_TERMINATE_CURRENT")
            }
